    ...
    <section class="contact__section section--padding">
        <div class="container">
            <div class="section__heading text-center mb-40">
                <h2 class="section__heading--maintitle text__secondary mb-10">N'hésitez pas à nous contacter</h2>
                <p class="section__heading--desc">
                    Profitez des soldes en cours sur les UC de PUBG pour débloquer des avantages en jeu, tout en bénéficiant
                    de réductions sur les abonnements Spotify et Netflix pour enrichir vos sessions de jeu et vos
                    ...
                    <div class="col-lg-5">
                        <div class="contact__info border-radius-10">
                            <div class="contact__info--items">
                                <h3 class="contact__info--content__title text-white mb-15">Contactez-Nous</h3>
                                <div class="contact__info--items__inner d-flex">
                                    ...
                                    <div class="contact__info--content">
                                        <p class="contact__info--content__desc text-white">
                                            ...
                                            <br>
                                            <a href="tel:++01234-5688765">+90 552 819 72 68</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="contact__info--items">
                                <h3 class="contact__info--content__title text-white mb-15">Adresse e-mail</h3>
                                <div class="contact__info--items__inner d-flex">
                                    <div class="contact__info--icon">
                            ...
                            <div class="contact__info--items">
                                <h3 class="contact__info--content__title text-white mb-15">Emplacement du bureau</h3>
                                <div class="contact__info--items__inner d-flex">
                                    <div class="contact__info--icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="31.57" height="31.13"
                                            viewBox="0 0 31.57 31.13">
                                    ...
                                    <div class="contact__info--content">
                                        <p class="contact__info--content__desc text-white">Görükle Mah. Öçoluk Cad. No: 38
                                            D32 Akay Apart. Nilüfer/Bursa</p>
                                    </div>
                                </div>
                            </div>
                            <div class="contact__info--items">
                                <h3 class="contact__info--content__title text-white mb-15">Suivez-nous</h3>
