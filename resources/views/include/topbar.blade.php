                ...
                <li class="header__contact--info__list text-white">
                    <svg class="header__contact--info__icon" xmlns="http://www.w3.org/2000/svg" width="15.797"
                        ...
                        <path
                            ...
                            fill="currentColor" stroke="currentColor" stroke-miterlimit="10" stroke-width="32" />
                    </svg>
                    <a href="tel:+8543553004">+90 541 886 90 37</a>
                </li>
                <li class="header__contact--info__list text-white">
                    ...
                    <a href="mailto:demo@example.com">olvanotjcs@gmail.com</a>
                </li>
            </ul>
        </div>
    </div>
