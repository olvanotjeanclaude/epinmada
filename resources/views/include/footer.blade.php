        ...
        <div class="main__footer section--padding d-none">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            <a class="footer__logo" href="index.html"><img class="footer__logo--img display-block"
                                    src="assets/img/logo/nav-logo-white.webp" alt="footer-logo"></a>
                                ...
                                <ul class="social__shear d-flex">
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8.239" height="15.984"
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank" href="https://twitter.com">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.492"
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14.497" height="14.492"
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14.419" height="14.419"
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            href="https://www.linkedin.com">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="15.49" height="15.582"
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Recent Post <button class="footer__widget--button"
