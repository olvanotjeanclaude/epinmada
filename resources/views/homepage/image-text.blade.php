<section class="image__with--text__section section--padding">
            ...
            <div class="col">
                <div class="image__with--text__content">
                    <h2 class="image__with--text__title mb-18">Most Talented Builders
                        Architects Drone.</h2>
                    <p class="image__with--text__desc mb-25">Beyond more stoic this along goodness this sed wow manatee
                        mongos
    ...
    <img class="image__with--text__position--shape display-block"
        src="{{ asset('assets/img/other/image-with-text-section-shape.webp') }}" alt="shape img">
</section>
