        ...
        <div class="team__container">
            <div class="row row-cols-md-3 row-cols-sm-2 row-cols-2 mb--n30">
                ...
                <div class="col custom-col mb-30">
                    <article class="team__card">
                        <div class="team__card--thumbnail">
                            <img class="team__card--thumbnail__img display-block" src="assets/img/other/team2.webp"
                                alt="team-thumb">
                        </div>
                        <div class="team__card--content ">
                ...
                <div class="col custom-col mb-30">
                    <article class="team__card">
                        <div class="team__card--thumbnail">
                            <img class="team__card--thumbnail__img display-block" src="assets/img/other/team3.webp"
                                alt="team-thumb">
                        </div>
                        <div class="team__card--content ">
